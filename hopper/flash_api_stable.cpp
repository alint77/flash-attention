...
inline bool get_pagedkv_tma(Flash_fwd_params const& params) {
    ...
    auto kBlockMN_kernel_args_sm90 = tile_size_fwd_sm90(params.d_rounded, params.dv_rounded, params.is_causal, params.is_local, params.is_e4m3 ? 1 : 2 /*element_size*/, false /*v_colmajor*/, false /*paged_kv_non_TMA*/, params.softcap > 0.f, use_small_local_fwd(params));
...
inline bool get_pack_gqa(Flash_fwd_params const& params) {
    ...
    // This needs to match the kernel configs
    auto kBlockMN_kernel_args_sm90 = tile_size_fwd_sm90(params.d_rounded, params.dv_rounded, params.is_causal, params.is_local, params.is_e4m3 ? 1 : 2 /*element_size*/, false /*v_colmajor*/, params.page_table && !params.pagedkv_tma, params.softcap > 0.f, use_small_local_fwd(params));
    int const kBlockM = std::get<0>(kBlockMN_kernel_args_sm90);
...
mha_fwd_get_scheduler_metadata(
    ...
    if (use_prepare_varlen) {
        // Externally supplied scheduler metadata always drives the default kernel: the gate's
        // !skip_scheduler_metadata_computation term makes mha_fwd reject the small-local path
        // whenever this metadata is reused.  Emit the matching (default) tile explicitly rather
        // than relying on use_small_local_fwd() being false here for an unrelated reason.
        auto kBlockMN_kernel_args_sm90 = tile_size_fwd_sm90(params.d_rounded, params.dv_rounded, params.is_causal, params.is_local, params.is_e4m3 ? 1 : 2 /*element_size*/, false /*v_colmajor*/, params.page_table && !params.pagedkv_tma, params.softcap > 0.f, false /*small_local*/);

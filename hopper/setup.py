...
SHORT_SEQ_TILES = os.getenv("FLASH_ATTENTION_SHORT_SEQ_TILES", "FALSE") == "TRUE"
...
def create_build_config_file():
    CONFIG = {
        "build_flags": {
            ...
            "FLASHATTENTION_SHORT_SEQ_TILES": SHORT_SEQ_TILES,
...
if not SKIP_CUDA_BUILD:
    ...
    feature_args = (
        ...
        + (["-DFLASHATTENTION_SHORT_SEQ_TILES"] if SHORT_SEQ_TILES else [])
